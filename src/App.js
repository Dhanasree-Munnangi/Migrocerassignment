...
function App() {
  ...
  function onChangeHandle(e){
    ...
    const sr=arrData.filter(item => item.category_level1.toLowerCase().startsWith(e.target.value.toLowerCase()))
    setArrData(sr);
  }
  function onChangeHandle2(e){
    if(e.target.value == ""){
        window.location.reload(true)
        const tempArr=arrData;
        setArrData(arrData)
    ...
    const sr=arrData.filter(item => item.category_level2.toLowerCase().startsWith(e.target.value.toLowerCase()))
    setArrData(sr);
  }
  function onChangeHandle3(e){
    if(e.target.value == ""){
        window.location.reload(true)
        const tempArr=arrData;
        setArrData(arrData)
    ...
    const sr=arrData.filter(item => item.category_level3.toLowerCase().startsWith(e.target.value.toLowerCase()))
    setArrData(sr);
  }
  function onChangeHandle4(e){
    if(e.target.value == ""){
      window.location.reload(true)
      const tempArr=arrData;
      setArrData(arrData)
    ...
    const sr=arrData.filter(item => item.name.toLowerCase().startsWith(e.target.value.toLowerCase()))
  ...
  return (
    <div className="App">
      ...
      <input onChange={onChangeHandle2}/>
      <input onChange={onChangeHandle3}/>
      <input onChange={onChangeHandle4}/>
      <div>
          <br></br>
        <table style={{border:"1px solid #000", backgroundColor: ' yellow'}}>
          <tr style={{border:"1px solid #000"}}>
          ...
          
            {
              arrData.map(item => {
                return(
                <tr style={{width: '50%', backgroundColor: 'white'}}>
                <td style={{ width: '30%',border:"1px solid #000"}}>{item.name}</td>
                <td style={{width: '20%', border:"1px solid #000"}}>{item.category_level1}</td>
                <td style={{width: '30%',border:"1px solid #000"}}>{item.category_level2}</td>
                <td style={{width: '30%',border:"1px solid #000"}}>{item.category_level3}</td>
                </tr>
                )
              })
            }
